...
public static class CreateSaleHandlerTestData
{
    ...
    private static readonly Faker<CreateSaleCommand> createSaleHandlerFaker = new Faker<CreateSaleCommand>()
        ...
        .RuleFor(s => s.Items, f => GenerateItemsCommand(f.Random.Int(1, 5)));
    ...
    private static IEnumerable<CreateItemSaleCommand> GenerateItemsCommand(int count)
    {
        var faker = new Faker<CreateItemSaleCommand>()
    ...
    private static readonly Faker<Sale> saleFaker = new Faker<Sale>()
        ...
        .RuleFor(s => s.Items, f => GenerateItemsSale(f.Random.Int(1, 5)));
    ...
    /// <returns>A new list of Item Sale</returns>
    private static List<ItemSale> GenerateItemsSale(int count)
    {
