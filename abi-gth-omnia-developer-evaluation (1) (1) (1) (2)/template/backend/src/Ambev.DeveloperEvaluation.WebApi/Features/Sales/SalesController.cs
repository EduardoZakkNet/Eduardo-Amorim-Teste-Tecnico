...
public class SalesController : BaseController
{
    ...
    /// <param name="logger">Logger of Serilog</param>
    ...
    {
        _logger.LogInformation($"Initiating the search request for Sale ID {id}");
    ...
    {
        _logger.LogInformation($"Initiating the deletion request for Sale ID {id}");
    ...
    {
        _logger.LogInformation($"Initiating the creation request for Sale");
    ...
    {
        _logger.LogInformation($"Initiating the updating request for Sale");
